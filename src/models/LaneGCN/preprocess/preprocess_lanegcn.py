...
from preprocess.data_class.data import LyftDataset as Dataset, split_scenes, collate_fn, from_numpy, ref_copy
from preprocess.map_class.lane_segment import LaneSegment
...
cfg = {
    ...
    # 'train_data_loader': 'scenes/splited_scenes/train_zarr_splited/train_zarr_1.zarr',
    # 'val_data_loader': 'scenes/splited_scenes/validate_zarr_splited/validate_zarr_1.zarr',
    # 'test_data_loader': 'scenes/splited_scenes/test_zarr_splited/test_zarr_0.zarr',  
    ...
    "preprocess_train": os.path.join(PREPROCESSED_ROOT, "preprocessed_data/preprocessed_train", "train_crs_dist6.p"),
    "preprocess_val": os.path.join(PREPROCESSED_ROOT, "preprocessed_data/preprocessed_val", "val_crs_dist6.p"),
    "preprocess_test": os.path.join(PREPROCESSED_ROOT, "preprocessed_data/preprocessed_test", "test_test.p"),
}
